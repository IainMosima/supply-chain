...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 86283)), "/home/space/Desktop/supply-chain-app/frontend/app/contact-us/page.tsx"],
      ...
      },
        {
          ...
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 38673))).default(props))],
    apple: [],
    openGraph: [],
    twitter: [],
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 45596)), "/home/space/Desktop/supply-chain-app/frontend/app/layout.tsx"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 38673))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/home/space/Desktop/supply-chain-app/frontend/app/contact-us/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 55428))
...
/* harmony import */ var _components_ContactUs_ContactUs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5474);
/* harmony import */ var _components_ContactUs_ContactUs__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_components_ContactUs_ContactUs__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(34212);



const contactUs = ()=>{
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((_components_ContactUs_ContactUs__WEBPACK_IMPORTED_MODULE_1___default()), {});
};
...
var __webpack_exports__ = __webpack_require__.X(0, [79,37,793], () => (__webpack_exec__(92209)));
