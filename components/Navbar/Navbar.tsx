...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <marquee className='text-purple absolute lg:top-[7.9rem] md:top-[8rem] top-[6.6rem] italic text-md font-extrabold'>Your Trusted Supply Chain Solutions Partner</marquee>
